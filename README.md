...
## Note
This project was accepted as an [example](https://github.com/atsamd-rs/atsamd/tree/master/boards/wio_terminal/examples/snake.rs) on the rust [atsamd](https://github.com/atsamd-rs/atsamd) repo.
